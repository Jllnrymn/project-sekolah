                       ...
                       @foreach($room as $kamar)
                                <div class="col-md-4 col-sm-6">
                                  <div id="serv_hover" class="room" >
                                    <div class="room_img">
                                    <figure><img  style="height: 200px; object-fit: cover;" src="room/{{ $kamar->gambar }}" alt="#"/></figure>
                                    </div>
                                  <div class="bed_room">
                                <h3>{{ $kamar->nama_kamar }}</h3>
                              <p>{{ Str::limit($kamar->deskripsi,100) }}</p>
                              <a href="{{url('room_detail',$kamar->id)}}" class="btn btn-outline-info">detail room</a>
                           </div>
                         </div>
                      </div>
                       @endforeach
